...
def create_tel(user_tel,user_slots):

    class_ = tel_map.get(user_tel,user_slots)
...
class HALE(object):
    ...
    def __init__(self, nSlots=3):
        self.observer = Observer.at_site('Palomar', name='HALE')
        self.readOutTime = 60.
        self.slewrate = 0.75 # degrees per second
        self.mounttype = 'equatorial'
        self.wrapLimitAngle = None
        self.deckAzLim1 = 0
        self.deckAzLim2 = 0
        self.deckAltLim = 0
        self.vigLim = 20
